    ...
    <div>
      <nav className=" navigation__nav text-center p-4 ">
        <div className="pref mt-5">
          <div className="pref-img">
            <Image
              ...
              alt="my image"
            />
            <div className="hi-icon position-absolute">👋</div>
          </div>
        ...
        <ul className="navigation__list d-flex flex-column mt-5 mb-5 gap-3">
          <li className={`navigation__item ${isActive("/") ? "active" : ""
            }`}>
            <Link
              href="/"
              className={`navigation__link p-3 d-flex align-items-center gap-3 ${isActive("/") ? "active" : ""
                }`}
              passHref
            >
              <svg
          ...
          <li className={`navigation__item ${isActive("/Portfolio") ? "active" : ""
            }`}>
            <Link
              href="/Portfolio"
              className={`navigation__link p-3 d-flex align-items-center gap-3 ${isActive("/Portfolio") ? "active" : ""
                }`}
              passHref
            >
              <svg
          ...
          <li className={`navigation__item ${isActive("/Resume") ? "active" : ""
            }`}>
            <Link
              href="/Resume"
              className={`navigation__link p-3 d-flex align-items-center gap-3 ${isActive("/Resume") ? "active" : ""
                }`}
              passHref
            >
              <svg
          ...
          <li className={`navigation__item ${isActive("/Services") ? "active" : ""
            }`}>
            <Link
              href="/Services"
              className={`navigation__link p-3 d-flex align-items-center gap-3 ${isActive("/Services") ? "active" : ""
                }`}
              passHref
            >
              <svg
          ...
          <li className={`navigation__item ${isActive("/contact") ? "active" : ""
            }`}>
            <Link
              href="/contact"
              className={`navigation__link p-3 d-flex align-items-center gap-3 ${isActive("/contact") ? "active" : ""
                }`}
              passHref
            >
              <svg
      ...
      <div className="small-pages-nav">
      </div>
      <div className="w-100 p-3 d-none nav-small">
        <div className="">
